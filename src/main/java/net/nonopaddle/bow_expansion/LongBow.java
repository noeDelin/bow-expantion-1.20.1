...
public class Longbow extends BowItem implements GeoItem{
    ...
    public void onStoppedUsing(ItemStack stack, World world, LivingEntity user, int remainingUseTicks) {
        this.animationController.tryTriggerAnimation("shoot");
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
        this.animationController.tryTriggerAnimation("draw");
    ...
    public void registerControllers(ControllerRegistrar controller) {
        this.animationController.triggerableAnim("Draw", RawAnimation.begin().then("longbow.draw", Animation.LoopType.HOLD_ON_LAST_FRAME));
        this.animationController.triggerableAnim("Shoot", RawAnimation.begin().then("longbow.shoot", Animation.LoopType.HOLD_ON_LAST_FRAME));
